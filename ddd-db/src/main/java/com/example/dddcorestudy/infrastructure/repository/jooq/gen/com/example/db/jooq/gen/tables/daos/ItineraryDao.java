...
public class ItineraryDao extends DAOImpl<ItineraryRecord, ItineraryVo, Integer> {
    ...
    @Override
    public Integer getId(ItineraryVo object) {
        return object.getId();
    }
     ...
     */
    public List<ItineraryVo> fetchRangeOfJId(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(JItinerary.ITINERARY.ID, lowerInclusive, upperInclusive);
    }
     ...
     */
    public List<ItineraryVo> fetchRangeOfJCargoId(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(JItinerary.ITINERARY.CARGO_ID, lowerInclusive, upperInclusive);
    }
    ...
    /**
     * Fetch records that have <code>leg_id BETWEEN lowerInclusive AND upperInclusive</code>
     */
    public List<ItineraryVo> fetchRangeOfJLegId(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(JItinerary.ITINERARY.LEG_ID, lowerInclusive, upperInclusive);
    }
