...
public class CargoToLegVo implements Serializable {

    private static final long serialVersionUID = 1997396806;

    private final Integer id;
    private final Integer cargoId;
    private final Integer legId;

    public CargoToLegVo(CargoToLegVo value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CargoToLegVo other = (CargoToLegVo) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CargoToLegVo (");
